...
Suprisingly, our K-Means model performed poorly, as evident by the Silhouette scores close to zero.
...
As our primary difficulty in solving this problem was our data, it would be worthwile to spend more time on refining our dataset.
...
Deep learning might be able to learn the complicated, higher-order relations between character attack types and damase, as well as how raw data,
